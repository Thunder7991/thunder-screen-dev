<template>
  <div class="order-map">
    ...
    <vue-echarts :option="options" v-else></vue-echarts>
  </div>
</template>
  ...
  setup(props) {
    ...
    const update = async () => {
      fetch("./assets/map.json")
        ...
        .then(data => {
          const geoGpsMap = {
            "1": [116.404763, 39.913581],
            "2": [121.479087, 31.236799],
            "3": [114.063402, 22.549524],
            "4": [113.272004, 23.135336],
            "5": [120.212061, 30.254579],
            "6": [118.800697, 32.065142]
          };
          //每个城市的坐标
          const geoCoordMap = {
            江苏: [118.8062, 31.9208],
          ...
          for (let i = 0; i < year.length; i++) {
            _option.options.push({
              ...
              series: [
                {
                  type: "effectScatter",
                  coordinateSystem: "geo", //geo:自定义极坐标系
